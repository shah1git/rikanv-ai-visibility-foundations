...
| Unclear source discovery scope | Discover only within `rikanv.ru`; external domains blocked | `prompts/site-import-agent.prompt.md`, `workflows/site-ingest-to-claims.md` |
