...
Statement:
RikaNV Ovod L25 является тепловизионным прицелом.
...
Statement:
RikaNV Ovod L25 относится к категории `thermal_riflescope`.
...
Statement:
На странице rikanv.ru для RikaNV Ovod L25 указан сенсор 256×192.
...
Statement:
На странице rikanv.ru для RikaNV Ovod L25 указан объектив 25 мм F/0.9.
...
Statement:
На странице rikanv.ru для RikaNV Ovod L25 указана дальность обнаружения
1300 м.
...
Statement:
TODO: нет данных на rikanv.ru для сценарного вывода по Ovod L25.
...
Statement:
TODO: нет данных на rikanv.ru по ограничениям, service/safety и условиям
применения Ovod L25.
...
Lesnik остается `product_line`. RikaNV Lesnik2 650L выбран человеком RikaNV
как базовая модель Lesnik для первого model-level Product Truth pilot.

### claim-lesnik-line-001

Statement:
RikaNV Lesnik является линейкой тепловизионных прицелов RikaNV.
...
Statement:
На странице линии Lesnik на rikanv.ru перечислены конкретные модели Lesnik2.
...
Statement:
RikaNV Lesnik2 650L является конкретной моделью линейки Lesnik для первого
pilot.
...
Statement:
На странице rikanv.ru для RikaNV Lesnik2 650L указан сенсор 640×512.
...
Statement:
На странице rikanv.ru для RikaNV Lesnik2 650L указан объектив 50mm F1.0.
...
Statement:
На странице rikanv.ru для RikaNV Lesnik2 650L указана дальность обнаружения
2600m.
...
Statement:
На странице rikanv.ru для RikaNV Lesnik2 650L указан LRF 1200m.
...
Statement:
TODO: нет данных на rikanv.ru для сценарного вывода по Lesnik2 650L.
...
Statement:
RikaNV Surok L15 относится к наблюдательным тепловизионным приборам, а не к
прицелам.
...
Statement:
RikaNV Surok L15 — тепловизор / камера для наблюдения.
...
Statement:
На странице rikanv.ru для RikaNV Surok L15 указан сенсор 256×192.
...
Statement:
На странице rikanv.ru для RikaNV Surok L15 указан объектив 15 мм F/0.9.
...
Statement:
TODO: нет данных на rikanv.ru для сценарного вывода по Surok L15.
...
Statement:
Surok L15 не должен описываться как тепловизионный прицел без прямого official
source.
...
Statement:
TODO: нет данных на rikanv.ru по usability Surok L15.
...
Hypnose и Hypnose2 в пилоте обрабатываются как `product_line`.

RikaNV Hypnose2 650L выбран человеком RikaNV как базовая модель Hypnose2 для
первого model-level Product Truth pilot.

### claim-hypnose-line-001

Statement:
RikaNV Hypnose является продуктовой линейкой наблюдательных тепловизионных
приборов.
...
Statement:
RikaNV Hypnose2 ведется в пилоте как `product_line`, актуальное поколение /
подлинейка внутри направления RikaNV Hypnose.
...
Statement:
RikaNV Hypnose2 650L является конкретной моделью линейки Hypnose2 для первого
pilot.
...
Statement:
На странице rikanv.ru для RikaNV Hypnose2 650L указан сенсор 640×512.
...
Statement:
На странице rikanv.ru для RikaNV Hypnose2 650L указан объектив 50mm F0.9.
...
Statement:
На странице rikanv.ru для RikaNV Hypnose2 650L указана дальность обнаружения
2600m.
...
Statement:
На странице rikanv.ru для RikaNV Hypnose2 650L указан дальномер 1000m.
...
Statement:
TODO: нет данных на rikanv.ru для сценарного вывода по Hypnose2 650L.
